...
<a class="logo" href="../index.php"><img src="../images/yamashialogo.png" alt="ヤマシアロゴ"　width="80px" height="40px"></a>
    ...
    <div class="top-main">
      ...
      <a class="a4">4. 開始初期からの徹底した情報共有によりを推進します</a>
    </div>
    ...
    <div class="carousel" data-flickity='{ "wrapAround": true }'>
      ...
      <div class="carousel-cell">
        ...
        <h4>（※）案件途中の制約付き進行を余儀なくされる場合、
          また、OSやツールのバージョンアップによるセキュリティ／脆弱性の保証が将来的になくなるリスクについては、対応できない可能性がございます。
          案件途中でのニュース・脆弱性速報による検知について、その先の継続については、内容精査のもと別途ご相談となります。予めご了承ください。
        </h4>
      </div>
      <div class="carousel-cell">
        <p>3. 各種サービス／ソリューションの適用を促進します</p>
        <h3>■フリーのツール(JIRA, Redmine, TRAC, etc)から、有料サービスまで、WEB環境での共有環境構築についてご相談いただけます。</h3>
        <h3>■PDCA＋プロトタイプモデルのスピーディーなソリューション(各種クラウド, xampp, conflict5 etc)
            のご利用を承っております。マニュアル・手順整備についてもぜひご相談ください。
        </h3>
      </div>
    </div>
        <div class="main2">
